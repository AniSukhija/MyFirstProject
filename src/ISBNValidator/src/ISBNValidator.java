...
public class ISBNValidator {
    ...
    public ISBNValidator()  {
        filename = "isbn_files 2/isbn1.dat";
        int lines = 0;
        try {
    ...
    public boolean isValidISBN(String isbn) {
        ...
        return (isbn.substring(0, 3).equals("978") || isbn.substring(0, 3).equals("979")) && (sum % 10 == 0);
    }
    ...
    public void runProgram()    {
        ...
        while(true) {
            System.out.println("All ISBN data has been imported 1and validated. Would you like to:");
